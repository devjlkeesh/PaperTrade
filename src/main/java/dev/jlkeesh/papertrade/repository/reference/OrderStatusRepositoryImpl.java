...
@Repository
public class OrderStatusRepositoryImpl extends GenericDao<OrderStatus, Long, OrderStatusCriteria> implements OrderStatusRepository {

    @Override
    protected void defineCriteriaOnQuerying(OrderStatusCriteria criteria, List<String> whereCause, Map<String, Object> params, StringBuilder queryBuilder) {
